...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"peerjs.js":[function(require,module,exports) {
var define;
    ...
    function shimGetStats(window) {
      ...
      window.RTCPeerConnection.prototype.getStats = function getStats() {
        ...
        var _arguments3 = Array.prototype.slice.call(arguments),
            selector = _arguments3[0],
            onSucc = _arguments3[1],
            onErr = _arguments3[2]; // If selector is a function then we are in the old style stats so just
    ...
    function shimPeerConnection(window) {
      ...
      window.RTCPeerConnection.prototype.getStats = function getStats() {
        var _arguments4 = Array.prototype.slice.call(arguments),
            selector = _arguments4[0],
            onSucc = _arguments4[1],
            onErr = _arguments4[2];
...
},{}],"depth2web-client.js":[function(require,module,exports) {
"use strict";
...
var Depth2Web = /*#__PURE__*/function () {
  function Depth2Web(addr) {
    _classCallCheck(this, Depth2Web);
    ...
    this.peer = new _peerjs.default(this.peer_net);
  ...
  _createClass(Depth2Web, [{
    ...
    value: function connect() {
      ...
      this.connection.on("data", function (sent) {
        if (sent.event == "depth") {
          this.depthBlob[sent.id] = new Blob([sent.data], {
            type: 'image/webp'
          });
        ...
        if (sent.event == "color") {
          this.colorBlob[sent.id] = new Blob([sent.data], {
            type: 'image/webp'
          });
    ...
    key: "deviceCount",
    value: function deviceCount() {}
  }, {
    key: "depthCount",
    value: function depthCount() {
      return this.depthURL.length;
    }
  }, {
    key: "colorCount",
    value: function colorCount() {
      return this.colorURL.length;
    }
  }, {
    key: "getDepthBlob",
    value: function getDepthBlob() {
      if (this.depthBlob) {
    ...
    key: "displayDepthImage",
    value: function displayDepthImage() {
    ...
    key: "displayColorImage",
    value: function displayColorImage() {
...
},{"./peerjs":"peerjs.js"}],"../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","depth2web-client.js"], null)
//# sourceMappingURL=/depth2web-client.05a61ba4.js.map